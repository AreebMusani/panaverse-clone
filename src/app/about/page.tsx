  ...
  return (
    <div className="">
      ...
      <div className="flex m-10">
        ...
        />
        {/* </div> */}
        <div className="bg-slate-700 text-white p-10 my-10 -ml-10">
          <h1 className="border-l-blue-600 border-l-8 pl-4 font-bold font-serif text-3xl md:text-4xl line leading-tight">
            Dr. Arif Alvi
          </h1>
