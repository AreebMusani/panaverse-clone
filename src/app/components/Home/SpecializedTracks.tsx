    ...
    return (
        <div className='text-center mt-20  box-border'>
            ...
            {/* flex justify-center items-stretch flex-wrap */}
                <div className='flex flex-col shadow-xl transition-all duration-300 hover:scale-105'>
                    {/* w-full sm:w-1/2 md:w-1/4 p-5 */}
                    ...
                    <p className='flex-grow text-justify text-base px-3 text-gray-500 mb-3'>Web 3.0 and Metaverse specialization focuses on developing full-stack Web 3.0 and Metaverse</p>
                ...
                <div className='flex flex-col shadow-xl transition-all duration-300 hover:scale-105'>
                    ...
                    <p className='flex-grow text-justify h-fr text-base px-3 text-gray-500 mb-3'>The Cloud-Native Computing Specialization focuses on Containers, Kubernetes, and CDK for Kubernetes.</p>
                    <button className='self-center text-white text-lg font-bold shadow-lg mb-3 px-6 py-2 rounded-2xl bg-blue-600 hover:bg-blue-700'>Apply Now</button>
                </div>
                <div className='flex flex-col shadow-xl transition-all duration-300 hover:scale-105'>
                    {/* w-full sm:w-1/2 md:w-1/4 p-5 */}
                    ...
                    <p className='flex-grow text-justify h-fr text-base px-3 text-gray-500 mb-3'>The Ambient Computing and IoT Specialization focuses on building Smart Homes, and Cities using Voice computing and Embedded Devices.</p>
                    <button className='self-center text-white text-lg font-bold shadow-lg mb-3 px-6 py-2 rounded-2xl bg-blue-600 hover:bg-blue-700'>Apply Now</button>
                </div>
